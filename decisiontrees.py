...
outputs = ['n', 't', 't', 'm', 'f']
init_entr = entropy_calc(outputs)
print("Initial Entropy: " + str(init_entr))
print()

outputs_f1 = [['t', 't', 'f'], ['n', 'm']]
f1_entr = entropy_of_feature(outputs_f1)
...
f2_entr = entropy_of_feature(outputs_f2)
...
f3_entr = entropy_of_feature(outputs_f3)
...
f4_entr = entropy_of_feature(outputs_f4)
